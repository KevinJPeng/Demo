...
enum E_ActionMethod
{
	...
	amScreenCapture,							 //截图（可指定元素截取）
	amAttributeCustom,							 //属性自定义
	amMax,                                       //一级菜单的最大
};
...
enum E_TaskType
{
	...
	ttDataAddLanmu,								//添加栏目（用于建站）
	ttDataAddArticle,							//添加文章
	ttDataAddCollect,							//添加数据采集
	ttDataModifyLanmu,							//修改栏目数据
	ttDataDelLanmu,								//删除栏目数据
	ttDataPostNews,								//发布新闻数据
...
enum E_CLICK_TYPE
{
	...
	ClickDBMouse = 3,	//双击鼠标
	ClickRefresh = 4,	//点击后刷新页面
	ClickJumpURL = 5,	//点击跳转网页
};
...
enum E_VERIFY_TYPE
{
	...
	evtFlash			= 3,		//flash
	evtTelephone		= 4,		//手机号
	evtTelephoneCode	= 5,		//手机验证码
	evtEMail			= 6,		//邮箱
	evtEMailCode		= 7,        //邮箱验证码
	evtDragCode			= 8,		//拖动型验证码
	evtWeiXin			= 9,		//微信验证码
	evtText2Pic			= 10,		//文本转图片
	evtDragCode_normal	= 11,		//拖动验证码（正常滑块）
	evtDragCode_slice	= 12,		//拖动验证码（拼图）
