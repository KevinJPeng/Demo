...
int CInternetHttp::ExecuteRequest(LPCTSTR strMethod, LPCTSTR strUrl, LPCTSTR strPostData, CString &strResponseText, DWORD &dwRet)
{
    CString strServer;
    CString strObject;
    DWORD dwServiceType;
...
int CInternetHttp::HttpGet(LPCTSTR strUrl, LPCTSTR strPostData, CString &strResponse, DWORD &dwRet)
{
    return ExecuteRequest(_T("GET"), strUrl, strPostData, strResponse, dwRet);
}

int CInternetHttp::HttpPost(LPCTSTR strUrl, LPCTSTR strPostData, CString &strResponse, DWORD &dwRet)
{
    return ExecuteRequest(_T("POST"), strUrl, strPostData, strResponse, dwRet);
}
...
BOOL CInternetHttp::LoginAndUploadFile( const CString& strFileLocalFullPath )
{
	CString strResponse;
	DWORD dwRet;
	HttpGet(m_LoginInfo.strServer, NULL, strResponse, dwRet/*, strUserName, strPwd*/);
