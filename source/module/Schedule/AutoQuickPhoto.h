...
class CAutoQuickPhoto: public CScheduleBase
{
public:
	CAutoQuickPhoto(CScheduleThread *pScheduleThread, CAutoGetKeywordPages *pAutoGetKeywordPages);
	...
	//通知任务结束的回调函数
	virtual void SetTaskMgr(CScheduleMgr *pMgr);
