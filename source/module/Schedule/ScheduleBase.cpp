...
CScheduleBase::CScheduleBase(void)
{

}

CScheduleBase::~CScheduleBase()
{

}

//判断进程是否存在
bool CScheduleBase::ProcessExist(TCHAR *pstrProcName, HANDLE *phProcess)
{
...
//启动进程
bool CScheduleBase::StartProcess(TCHAR *pstrProcName, TCHAR *pstrPort, HANDLE *phProcess)
{
	ASSERT(pstrProcName != NULL);
...
//结束指定进程
bool CScheduleBase::StopProcess(TCHAR *pstrProcName)
{
...
//结束指定进程
bool CScheduleBase::StopProcess(HANDLE hProcess)
{
...
//获取一个当前可用的端口号，用于启动主控
int CScheduleBase::GetPort(int nDefault)
{
	WSADATA wsaData;
...
//获取请求自动任务的地址
CString CScheduleBase::GetRequestURL(void)
{
	return _T("http://198.18.0.238:8092/PublishDataReady/GetTimingQuickPhotoData?userId=");
}

//获取提交自动任务结果的地址
CString CScheduleBase::GetPostDataURL(void)
{
	return _T("");
}