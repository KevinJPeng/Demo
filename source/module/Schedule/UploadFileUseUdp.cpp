...
CLogTrace g_UdpLog(_T("ScheduleUdp.log"),NULL);
...
void CUploadFileUseUdp::Init(void)
{
	...
	g_iniCfgFile.ReadString(_T("ConnectUseUdp"), _T("Ip"), strIp, "103.25.23.10");
...
bool CUploadFileUseUdp::OnReceive()
{
	...
	int ret = recvfrom(m_socket, buff, 1024, 0, (SOCKADDR*)&m_service, (int *)&dwLen);
