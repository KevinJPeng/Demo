...
public:
	...
	int HttpGet(LPCTSTR strUrl, LPCTSTR strPostData, CString &strResponse, DWORD codeType = CP_UTF8/*, CString strUserName = _T(""), CString strPwd = _T("")*/);
	int HttpPost(LPCTSTR strUrl, LPCTSTR strPostData, CString &strResponse/*, CString strUserName = _T(""), CString strPwd = _T("")*/);
//	int HttpPost(LPCTSTR strUrl, char* pstrPostData, CString &strResponse/*, CString strUserName = _T(""), CString strPwd = _T("")*/);
...
private:
	int ExecuteRequest(LPCTSTR strMethod, LPCTSTR strUrl, LPCTSTR strPostData, CString &strResponse, DWORD codeType = CP_UTF8);
//	int ExecuteRequest(LPCTSTR strMethod, LPCTSTR strUrl, char* pstrPostData, CString &strResponse, DWORD codeType = CP_UTF8);
	void Clear();
