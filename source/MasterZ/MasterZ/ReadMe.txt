========================================================================
    WIN32 应用程序：MasterZ 项目概述
========================================================================

应用程序向导已为您创建了此 MasterZ 应用程序。

本文件概要介绍组成 MasterZ 应用程序的每个文件的内容。
...
StdAfx.h，StdAfx.cpp
    这些文件用于生成名为 MasterZ.pch 的预编译头 (PCH) 文件和
