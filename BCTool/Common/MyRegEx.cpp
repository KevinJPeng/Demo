...
{
	//add by qy --- 20170930（不同IE版本下字符串大小写可能不同，会造成查找不到的问题，此处做统一小写处理）
	CStdString strInputTemp = strInput;
	...
	{
		CStdString strRegExTemp0 = strRegEx;
